...
for ($i = 6; $i >= 0; $i--) {
    ...
    <script>
        ...
        // Biểu đồ cho 7 ngày gần nhất
        const weeklyCtx = document.getElementById('weeklyChart').getContext('2d');
        const weeklyChart = new Chart(weeklyCtx, {
            type: 'bar', // Bạn có thể thay đổi thành 'line' nếu muốn
            data: {
                labels: <?php echo json_encode(array_reverse($dates)); ?>, // Ngày
                datasets: [{
                    label: 'Tổng tiền thu',
                    data: <?php echo json_encode(array_reverse($incomeData)); ?>,
                    backgroundColor: 'rgba(75, 192, 192, 0.5)',
                    borderColor: 'rgba(75, 192, 192, 1)',
                    borderWidth: 1
                }, {
                    label: 'Tổng tiền chi',
                    data: <?php echo json_encode(array_reverse($expenseData)); ?>,
